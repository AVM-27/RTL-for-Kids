...
HD_PWD='C:/Users/Adarsh Venugopal/Desktop/SEM 5/ELECTRONIC SYSTEM LEVEL DESIGN AND VERIFICATION/2_Bit_Counter/2_Bit_Counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_2bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source counter_2bit.tcl -notrace
