...
HD_PWD='C:/Users/Adarsh Venugopal/Desktop/SEM 5/ELECTRONIC SYSTEM LEVEL DESIGN AND VERIFICATION/2_Bit_Counter/2_Bit_Counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_2bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter_2bit.tcl
