...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xilinx_vip -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_17 -L processing_system7_vip_v1_0_19 -L xlslice_v1_0_4 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip --snapshot design_1_wrapper xil_defaultlib.design_1_wrapper xil_defaultlib.glbl -log elaborate.log
}
...
map_local_libs()
{
  ...
  local_libs=(axi_infrastructure_v1_1_0 axi_vip_v1_1_17 processing_system7_vip_v1_0_19 xlslice_v1_0_4)
